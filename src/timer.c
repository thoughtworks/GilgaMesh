...
static app_timer_id_t ledOffTimerMsId;
...
void timer_initialize(void) {
    ...
    EC(app_timer_create(&ledOffTimerMsId, APP_TIMER_MODE_REPEATED, turn_off_leds));
    EC(app_timer_start(ledOffTimerMsId, APP_TIMER_TICKS(MS_RATE_TO_TURN_OFF_ALL_LEDS, ATTR_TIMER_PRESCALER), NULL));
}
